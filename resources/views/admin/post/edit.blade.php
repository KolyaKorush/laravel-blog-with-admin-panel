                            ...
                            <div class="box-body">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="slug"  value="{{$post->slug}}" name="slug" placeholder="Slug">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" @if($post->status==1)checked @endif name="status"> Publish
                                        </label>
                                    </div>
                                </div>
                            </div>
